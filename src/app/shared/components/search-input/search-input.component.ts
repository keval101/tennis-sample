...
export class SearchInputComponent implements OnInit {
  ...
  @Input() placeHolderText: string = 'Search by name';
  ...
  @Output() control: EventEmitter<FormControl> =
  ...
  h2hLink(element: string | any) {
    return `/head-to-head/${this.type}/${element.replaceAll(
      ' ',
      '_'
